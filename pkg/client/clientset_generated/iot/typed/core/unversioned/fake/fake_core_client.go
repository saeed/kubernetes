...
import (
	unversioned "k8s.io/kubernetes/pkg/client/clientset_generated/iot/typed/core/unversioned"
...
func (c *FakeCore) SensorAccesses(namespace string) unversioned.SensorAccessInterface {
