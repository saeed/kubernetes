...
// This file is generated by client-gen with arguments: --clientset-name=iot --input=[api/]
...
type SensorAccessInterface interface {
	Create(*api.SensorAccess) (*api.SensorAccess, error)
	Update(*api.SensorAccess) (*api.SensorAccess, error)
	Delete(name string, options *api.DeleteOptions) error
	DeleteCollection(options *api.DeleteOptions, listOptions api.ListOptions) error
	Get(name string) (*api.SensorAccess, error)
	List(opts api.ListOptions) (*api.SensorAccessList, error)
...
func (c *sensorAccesses) Create(sensorAccess *api.SensorAccess) (result *api.SensorAccess, err error) {
	result = &api.SensorAccess{}
	err = c.client.Post().
		Namespace(c.ns).
...
func (c *sensorAccesses) Update(sensorAccess *api.SensorAccess) (result *api.SensorAccess, err error) {
	result = &api.SensorAccess{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("sensoraccesses").
...
func (c *sensorAccesses) Get(name string) (result *api.SensorAccess, err error) {
	result = &api.SensorAccess{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sensoraccesses").
...
func (c *sensorAccesses) List(opts api.ListOptions) (result *api.SensorAccessList, err error) {
	result = &api.SensorAccessList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("sensoraccesses").
