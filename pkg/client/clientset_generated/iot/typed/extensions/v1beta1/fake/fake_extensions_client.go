...
// This file is generated by client-gen with arguments: --clientset-name=iot --input=[api/v1,extensions/v1beta1]

package fake

import (
	v1beta1 "k8s.io/kubernetes/pkg/client/clientset_generated/iot/typed/extensions/v1beta1"
