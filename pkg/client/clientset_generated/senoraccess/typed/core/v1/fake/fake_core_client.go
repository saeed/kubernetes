...
import (
	v1 "k8s.io/kubernetes/pkg/client/clientset_generated/senoraccess/typed/core/v1"
...
func (c *FakeCore) SensorAccesses(namespace string) v1.SensorAccessInterface {
	return &FakeSensorAccesses{c, namespace}
}
